package cdu.zch.demo20quartz.service.impl;

import cdu.zch.demo20quartz.entity.domain.JobAndTrigger;
import cdu.zch.demo20quartz.entity.form.JobForm;
import cdu.zch.demo20quartz.mapper.JobMapper;
import cdu.zch.demo20quartz.service.JobService;
import cdu.zch.demo20quartz.utils.JobUtils;
...
public class JobServiceImpl implements JobService {
    ...
    public void addJob(JobForm form) throws Exception {
        ...
        // 构建Job信息
        JobDetail jobDetail = JobBuilder.newJob(JobUtils.getClass(form.getJobClassName()).getClass()).withIdentity(form.getJobClassName(), form.getJobGroupName()).build();
