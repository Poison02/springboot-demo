package cdu.zch.demo13mybatisplus.config;

import cdu.zch.demo13mybatisplus.constant.ResponseStatus;
...
public class OpenApiConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("Poison02", "https://zchch.top", "2069820192@qq.com"))
