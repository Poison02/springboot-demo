...
import cdu.zch.codegen.constants.GenConstants;
import cdu.zch.codegen.entity.ColumnEntity;
import cdu.zch.codegen.entity.GenConfig;
import cdu.zch.codegen.entity.TableEntity;
...
public class CodeGenUtil {
     ...
     * 生成代码
     */
    public static void generatorCode(GenConfig genConfig, Entity table, List<Entity> columns, ZipOutputStream zip) {
        //配置信息
     ...
     * 获取配置信息
     */
    private static Props getConfig(String fileName) {
