package cdu.zch.codegen.service.impl;
...
import cdu.zch.codegen.utils.CodeGenUtil;
import cdu.zch.codegen.utils.DbUtil;
...
public class CodeGenServiceImpl implements CodeGenService {
     ...
     */
    @Override
    public PageResult<Entity> listTables(TableRequest request) throws SQLException {
     ...
     */
    @Override
    public byte[] generatorCode(GenConfig genConfig) throws SQLException {
    ...
    private Entity queryTable(TableRequest request) throws SQLException {
        HikariDataSource dataSource = DbUtil.buildFromTableRequest(request);
        Db db = new Db(dataSource);
    ...
    private List<Entity> queryColumns(TableRequest request) throws SQLException {
        HikariDataSource dataSource = DbUtil.buildFromTableRequest(request);
        Db db = new Db(dataSource);
